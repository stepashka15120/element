                ...
                <div class="main__items">
                    ...
                    <li class="main__item">
                        <a href="<?=$arItem["DETAIL_PAGE_URL"]?>">
                            <img class="main__image" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="">
                            <p class="main__name"><?=$arItem["NAME"]?></p>
                        </a>
                        <a class="main__brand" href="#"><?=$arItem["PROPERTIES"]["BRAND"]["VALUE"]?></a>
                        <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="main__price">от <?=$arItem["PROPERTIES"]["PRICE"]["VALUE"]?> руб.</a>
                    </li>
                    <?endforeach;?>
                </div>
